...
@RestController
@RequestMapping("/api/owlstreetproduct-kafka")
public class OwlstreetproductKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OwlstreetproductKafkaResource.class);
    ...
    public OwlstreetproductKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
